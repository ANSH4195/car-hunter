...
- Makes/Models: Audi Q3/Q5/Q7/Q8 (SUVs only), BMW X1/X3/X5/X7 (SUVs only), Mercedes GLA/GLC/GLE/GLS (SUVs only), Volvo (any), VW Tiguan, Skoda Kodiaq, Jeep Compass, Ford Endeavour, Mitsubishi Pajero Sport
- Fuel: diesel only
- Year: >= 2017
- KMs: <= 110,000
